...
questions = [
    ...
    {"type": "text", "question": "√(-1) 2³ ∑ π...and it was delicious! خب وجه اشتراک این جمله و چیزی که شما میخوری و دوست داری چیه؟🙊", "answer": "پای",
     "correct_message": "اگر به اون میگی cream pie پس خودش میشه «پای»!باهوش خودمی و عاشقتم خب؟!"},

    {"type": "text", "question": "با این حروف کلمه مد نظر رو بساز: ی س چ ی و", "answer": "سوییچ",
...
def start(message):
    ...
    safe_send_message(user_id, "😃یزن بریم")
...
def check_answer(message):
    ...
    if user_answer == correct_answer:
        ...
        safe_send_message(user_id, "❌اشتباهه کیوت جون، دوباره امتحان کن.")
